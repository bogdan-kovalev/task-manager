...
(function () {
    var f = encodeURIComponent, g = window, k = decodeURIComponent, n = "shift", p = "replace", q = "split", t = "push", x = "test", z = "length", A = "join";
    var E = g, F = document, aa = E.location, ba = function () {
    }, ca = /\[native code\]/, G = function (a, b, c) {
        return a[b] = a[b] || c
    }, ea = function (a) {
        for (var b = 0; b < this[z]; b++)if (this[b] === a)return b;
        return -1
    }, fa = function (a) {
        a = a.sort();
        for (var b = [], c = void 0, d = 0; d < a[z]; d++) {
            var e = a[d];
            e != c && b[t](e);
            c = e
        }
    ...
    var M = G(J, "perf", H()), N = G(M, "g", H()), ha = G(M, "i", H());
    G(M, "r", []);
    H();
    H();
    var O = function (a, b, c) {
        ...
        b && 0 < b[z] && (b = P(b), c && 0 < c[z] && (b += "___" + P(c)), 28 < b[z] && (b = b.substr(0, 28) + (b[z] - 28)), c = b, b = G(ha, "_p", H()), G(b, c, H())[a] = (new Date).getTime(), O(a, "_p", c))
    }, P = function (a) {
        return a[A]("__")[p](/\./g, "_")[p](/\-/g, "_")[p](/\,/g, "_")
    };
    ...
    T[t](["jsl", function (a) {
        ...
        if (b = a.u)a = G(J, "us", []), a[t](b), (b = /^https:(.*)$/.exec(b)) && a[t]("http:" + b[1])
    }]);
    var ia = /^(\/[a-zA-Z0-9_\-]+)+$/, ja = /^[a-zA-Z0-9\-_\.,!]+$/, ka = /^gapi\.loaded_[0-9]+$/, la = /^[a-zA-Z0-9,._-]+$/, pa = function (a, b, c, d) {
        var e = a[q](";"), h = e[n](), m = S[h], l = null;
        m ? l = m(e, b, c, d) : U("no hint processor for: " + h);
        l || U("failed to generate load url");
        b = l;
        c = b.match(ma);
        (d = b.match(na)) && 1 === d[z] && oa[x](b) && c && 1 === c[z] || U("failed sanity: " + a);
        return l
    }, ra = function (a, b, c, d) {
        a = qa(a);
        ka[x](c) || U("invalid_callback");
        b = V(b);
        d = d && d[z] ? V(d) : null;
        var e = function (a) {
            return f(a)[p](/%2C/g, ",")
        ...
        return [f(a.g)[p](/%2C/g,
            ",")[p](/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.a ? "/am=" + e(a.a) : "", a.c ? "/rs=" + e(a.c) : "", a.f ? "/t=" + e(a.f) : "", "/cb=", e(c)][A]("")
    }, qa = function (a) {
        "/" !== a.charAt(0) && U("relative path");
        for (var b = a.substring(1)[q]("/"), c = []; b[z];) {
            a = b[n]();
            if (!a[z] || 0 == a.indexOf("."))U("empty/relative directory"); else if (0 < a.indexOf("=")) {
                b.unshift(a);
                break
            }
            c[t](a)
        ...
        a = {};
        for (var d = 0, e = b[z]; d < e; ++d) {
            var h = b[d][q]("="), m = k(h[0]), l = k(h[1]);
            2 == h[z] && m && l && (a[m] = a[m] || l)
        }
        b = "/" + c[A]("/");
        ia[x](b) || U("invalid_prefix");
        c = W(a, "k", !0);
        d = W(a, "am");
        e = W(a, "rs");
        a = W(a, "t");
        ...
        return null
    }, oa = /^https?:\/\/[a-z0-9_.-]+\.google\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/, na = /\/cb=/g, ma = /\/\//g, sa = function () {
        var a = K();
    ...
    var X = decodeURI("%73cript"), Y = function (a, b) {
        for (var c = [], d = 0; d < a[z]; ++d) {
            var e = a[d];
            e && 0 > ea.call(b, e) && c[t](e)
        }
        return c
    }, ta = function (a) {
        "loading" != F.readyState ? Z(a) : F.write("<" + X + ' src="' + encodeURI(a) + '"></' + X + ">")
    }, Z = function (a) {
        ...
        ua(a, c);
        var d = a ? a[q](":") : [], e = c.h || sa(), h = G(J, "ah", H());
        if (h["::"] && d[z]) {
            for (var m = [], l = null; l = d[n]();) {
                var u = l[q]("."), u = h[l] || h[u[1] && "ns:" + u[0] || ""] || e, B = m[z] && m[m[z] - 1] || null, C = B;
                B && B.hint == u || (C = {hint: u, b: []}, m[t](C));
                C.b[t](l)
            }
            var D = m[z];
            if (1 < D) {
        ...
        a = fa(a) || [];
        var d = b.callback, e = b.config, h = b.timeout, m = b.ontimeout, l = b.onerror, u = void 0;
        "function" == typeof l && (u = l);
        var B = null, C = !1;
        if (h && !m || !h && m)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";
        var l = G(L(c), "r", []).sort(), D = G(L(c), "L", []).sort(), y = [].concat(l), da = function (a, b) {
            if (C)return 0;
            E.clearTimeout(B);
            D[t].apply(D, r);
        ...
        0 < h && (B = E.setTimeout(function () {
            C = !0;
            m()
        }, h));
        var r = Y(a, D);
        if (r[z]) {
            var r = Y(a, l), v = G(J, "CP", []), w = v[z];
            v[w] = function (a) {
                if (!a)return 0;
                Q("ml1", r, y);
                var b = function (b) {
    ...
    var va = function (a, b) {
        if (J.hee && 0 < J.hel)try {
            ...
            b && b(c), J.hel--, ya("debug_error", function () {
                try {
                    g.___jsl.hefn(c)
                } catch (a) {
                    throw c;
    ...
    _c: {
        "jsl": {
            "ci": {
                ...
                "lexps": [81, 97, 99, 122, 123, 61, 45, 30, 79, 127],
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.45kQgOq01zo.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/t\u003dzcms/rs\u003dAGLTcCNK4fELAt9riTAyWe5qSReLsZTHIA",
            "u": "https://apis.google.com/js/client.js",
            "hee": true,
            "fp": "c7541b1b9ca3cf8e6905f4fbb06f1519dd5128b5",
            "dpo": false
        },
        "fp": "c7541b1b9ca3cf8e6905f4fbb06f1519dd5128b5",
